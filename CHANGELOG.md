...
- Explained in the Windows launcher when a non-Git installation cannot use automatic updates, instead of silently skipping the update and stale-build checks (#5123).
