...
- iPhone chat fields now keep the app shell aligned with the visible software-keyboard viewport instead of leaving Roleplay on the dark page backing; Roleplay also releases its inactive full-resolution background after each crossfade and avoids unused full-viewport compositor hints, reducing persistent WebKit visual memory (#5710, #5711).
