...
import { authorNotePresetsRoutes } from "./author-note-presets.routes.js";
import { trackerPresetsRoutes } from "./tracker-presets.routes.js";
...
export async function registerRoutes(app: FastifyInstance) {
  ...
  await app.register(authorNotePresetsRoutes, { prefix: "/api/author-note-presets" });
