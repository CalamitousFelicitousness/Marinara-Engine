...
export const createConnectionSchema = z.object({
  ...
  defaultForSfx: z.boolean().default(false),
  fallbackForSfx: z.boolean().default(false),
  defaultForMusic: z.boolean().default(false),
  fallbackForMusic: z.boolean().default(false),
