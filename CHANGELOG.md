...
- Professor Mari no longer tells you a change is done in the middle of a longer job when it has not happened (#5819). Her self-check used to look only at the very last thing she said in a run, so in a batch - "created the first character, now doing the second" - a claim about a step she had skipped was never checked. Every such claim is now checked as she goes, and she is told to carry the step out or say plainly that it is still outstanding. Mid-job checks stay deliberately narrow: only a claim with nothing behind it at all, or a change the store reports did not save.
